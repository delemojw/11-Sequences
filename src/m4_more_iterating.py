...
def run_test_count_positive_sines():
 ...
 # Test 11 (using the list [0, 1, 2, ... 550]
    sequence.append(550)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 93
    actual = sum_first_n([50, -10, 88, 9, 86], 5)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    for _ in range(500):
        sequence.append(random.randrange(-100, 100))
    expected = builtins.sum(sequence[:-200])
    actual = sum_first_n(sequence, 100)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
